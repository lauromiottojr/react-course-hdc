...
// with the "_" the react knows this argument is not required
// get all photos
...
export const photoSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(publishPhoto.pending, (state) => { // publish photo
            ...
            state.error = action.payload
            state.photo = {}
        }).addCase(updatePhoto.pending, (state) => { // update photo
            state.loading = true
            state.error = null
            ...
            state.error = action.payload
            state.photo = {}
        }).addCase(getPhoto.pending, (state) => { // get photos by id
            state.loading = true
            state.error = null
            ...
            state.error = null
            state.photo = action.payload
        }).addCase(like.fulfilled, (state, action) => { // like a photo
            state.loading = false
            state.success = true
            state.error = null
            // individual photo 
            ...
            state.loading = false
            state.error = action.payload
        }).addCase(comment.fulfilled, (state, action) => { // comment a photo
            state.loading = false
            state.success = true
            state.error = null
            ...
            state.loading = false
            state.error = action.payload
        }).addCase(getPhotos.pending, (state) => { // get all photos
            state.loading = true
            state.error = null
            ...
            state.error = null
            state.photos = action.payload
        }).addCase(searchPhotos.pending, (state) => { // search photos
            state.loading = true
            state.error = null
